...
{
    ZephioResult res = zephio_screen_init(24, 80);
...
{
    TEST_NE(zephio_screen_init(0, 80), ZEPHIO_OK);
    TEST_NE(zephio_screen_init(24, 0), ZEPHIO_OK);
    TEST_NE(zephio_screen_init(-1, 80), ZEPHIO_OK);
    TEST_NE(zephio_screen_init(24, -1), ZEPHIO_OK);
}
...
{
    zephio_screen_init(10, 10);
    zephio_screen_set_cell(0, 0, "X", ZEPHIO_COLOR_NONE, ZEPHIO_COLOR_NONE, 0);
    ZephioResult res = zephio_screen_init(20, 20);
    TEST_EQ(res, ZEPHIO_OK);
...
{
    zephio_screen_init(30, 60);
    ZephioSize s = zephio_screen_size();
    TEST_EQ(s.rows, 30);
    TEST_EQ(s.cols, 60);
    zephio_screen_free();
}
...
TEST_BEGIN(screen_set_cell_basic)
{
    ...
    zephio_screen_set_cell(5, 10, "A", fg, bg, ZEPHIO_ATTR_BOLD);
...
{
    zephio_screen_init(24, 80);
    zephio_screen_set_cell(0, 0, "\xC3\xBC", ZEPHIO_COLOR_NONE, ZEPHIO_COLOR_NONE, 0);

    ZephioCell *cell = &g_screen.back[0];
...
{
    zephio_screen_init(24, 80);
    zephio_screen_set_cell(-1, 0, "X", ZEPHIO_COLOR_NONE, ZEPHIO_COLOR_NONE, 0);
    zephio_screen_set_cell(24, 0, "X", ZEPHIO_COLOR_NONE, ZEPHIO_COLOR_NONE, 0);
    zephio_screen_set_cell(0, -1, "X", ZEPHIO_COLOR_NONE, ZEPHIO_COLOR_NONE, 0);
    zephio_screen_set_cell(0, 80, "X", ZEPHIO_COLOR_NONE, ZEPHIO_COLOR_NONE, 0);
    zephio_screen_free();
}
...
{
    zephio_screen_init(24, 80);
    zephio_screen_write(0, 0, "Hi", ZEPHIO_COLOR_NONE, ZEPHIO_COLOR_NONE, 0);
...
{
    zephio_screen_init(24, 80);
    zephio_screen_write(0, 79, "AB", ZEPHIO_COLOR_NONE, ZEPHIO_COLOR_NONE, 0);
...
{
    zephio_screen_init(24, 80);
    zephio_screen_write(0, 0, NULL, ZEPHIO_COLOR_NONE, ZEPHIO_COLOR_NONE, 0);
    zephio_screen_free();
}
...
{
    zephio_screen_init(24, 80);
    zephio_screen_fill(2, 3, 2, 2, "#", ZEPHIO_COLOR_NONE, ZEPHIO_COLOR_NONE, 0);
...
{
    zephio_screen_init(10, 10);
    zephio_screen_set_cell(0, 0, "A", ZEPHIO_COLOR_NONE, ZEPHIO_COLOR_NONE, 0);

    ZephioResult res = zephio_screen_resize(20, 20);
    TEST_EQ(res, ZEPHIO_OK);
    TEST_EQ(g_screen.rows, 20);
    TEST_EQ(g_screen.cols, 20);
...
{
    zephio_screen_init(10, 10);
    zephio_screen_set_cell(3, 3, "B", ZEPHIO_COLOR_NONE, ZEPHIO_COLOR_NONE, 0);

    ZephioResult res = zephio_screen_resize(5, 5);
    TEST_EQ(res, ZEPHIO_OK);
...
{
    zephio_screen_init(10, 10);
    ZephioResult res = zephio_screen_resize(10, 10);
    TEST_EQ(res, ZEPHIO_OK);
    zephio_screen_free();
}
...
{
    zephio_screen_init(10, 10);
    TEST_NE(zephio_screen_resize(0, 10), ZEPHIO_OK);
...
TEST_BEGIN(screen_box_single_basic)
{
    ...
    ZephioColor fg = ZEPHIO_COLOR_INDEX(7);
    ZephioColor bg = ZEPHIO_COLOR_INDEX(0);
    zephio_screen_box_single(0, 0, 4, 3, fg, bg, 0);

    ZephioCell *tl = &g_screen.back[0];
    ZephioCell *tr = &g_screen.back[3];
    ZephioCell *bl = &g_screen.back[2 * 80];
    ZephioCell *br = &g_screen.back[2 * 80 + 3];
    ZephioCell *top = &g_screen.back[1];
    ZephioCell *side = &g_screen.back[80];
...
TEST_BEGIN(screen_box_double_basic)
{
    ...
    ZephioColor fg = ZEPHIO_COLOR_INDEX(7);
    ZephioColor bg = ZEPHIO_COLOR_INDEX(0);
    zephio_screen_box_double(0, 0, 4, 3, fg, bg, 0);
...
{
    zephio_screen_init(24, 80);
    zephio_screen_box_single(0, 0, 1, 1, ZEPHIO_COLOR_NONE, ZEPHIO_COLOR_NONE, 0);
    zephio_screen_box_double(0, 0, 1, 1, ZEPHIO_COLOR_NONE, ZEPHIO_COLOR_NONE, 0);
    zephio_screen_free();
}
...
TEST_BEGIN(screen_invert_cell)
{
    ...
    ZephioColor fg = ZEPHIO_COLOR_INDEX(7);
    ZephioColor bg = ZEPHIO_COLOR_INDEX(0);
    zephio_screen_set_cell(5, 5, "X", fg, bg, 0);

    zephio_screen_invert_cell(5, 5);

    ZephioCell *cell = &g_screen.back[5 * 80 + 5];
...
{
    zephio_screen_init(24, 80);
    zephio_screen_invert_cell(-1, 0);
    zephio_screen_invert_cell(24, 0);
    zephio_screen_invert_cell(0, -1);
    zephio_screen_invert_cell(0, 80);
    zephio_screen_free();
}
