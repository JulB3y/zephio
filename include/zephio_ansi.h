...
ZEPHIO_API void ansi_move_cursor(ZephioContext *ctx, int row, int col);
/** @brief Move the cursor up by n rows. */
ZEPHIO_API void ansi_move_up(ZephioContext *ctx, int n);
/** @brief Move the cursor down by n rows. */
ZEPHIO_API void ansi_move_down(ZephioContext *ctx, int n);
/** @brief Move the cursor left by n columns. */
ZEPHIO_API void ansi_move_left(ZephioContext *ctx, int n);
/** @brief Move the cursor right by n columns. */
ZEPHIO_API void ansi_move_right(ZephioContext *ctx, int n);
/** @brief Save cursor position (DEC private). */
ZEPHIO_API void ansi_save_cursor(ZephioContext *ctx);
/** @brief Restore previously saved cursor position. */
ZEPHIO_API void ansi_restore_cursor(ZephioContext *ctx);

/** @brief Clear the entire screen. */
ZEPHIO_API void ansi_clear_screen(ZephioContext *ctx);
/** @brief Clear the entire current line. */
ZEPHIO_API void ansi_clear_line(ZephioContext *ctx);
/** @brief Clear from cursor to end of line. */
ZEPHIO_API void ansi_clear_line_right(ZephioContext *ctx);
/** @brief Clear from start of line to cursor. */
ZEPHIO_API void ansi_clear_line_left(ZephioContext *ctx);
/** @brief Clear from start of screen to cursor. */
ZEPHIO_API void ansi_clear_screen_above(ZephioContext *ctx);
/** @brief Clear from cursor to end of screen. */
ZEPHIO_API void ansi_clear_screen_below(ZephioContext *ctx);

/** @brief Set foreground to 256-color index. */
ZEPHIO_API void ansi_set_fg(ZephioContext *ctx, int color);
/** @brief Set background to 256-color index. */
ZEPHIO_API void ansi_set_bg(ZephioContext *ctx, int color);
/** @brief Set foreground to 24-bit RGB. */
ZEPHIO_API void ansi_set_fg_rgb(ZephioContext *ctx, int r, int g, int b);
/** @brief Set background to 24-bit RGB. */
ZEPHIO_API void ansi_set_bg_rgb(ZephioContext *ctx, int r, int g, int b);
/** @brief Reset all attributes and colors. */
ZEPHIO_API void ansi_reset(ZephioContext *ctx);
/** @brief Enable bold attribute. */
ZEPHIO_API void ansi_set_bold(ZephioContext *ctx);
/** @brief Enable dim/faint attribute. */
ZEPHIO_API void ansi_set_dim(ZephioContext *ctx);
/** @brief Enable italic attribute. */
ZEPHIO_API void ansi_set_italic(ZephioContext *ctx);
/** @brief Enable underline attribute. */
ZEPHIO_API void ansi_set_underline(ZephioContext *ctx);
/** @brief Enable blink attribute. */
ZEPHIO_API void ansi_set_blink(ZephioContext *ctx);
/** @brief Enable reverse video attribute. */
ZEPHIO_API void ansi_set_reverse(ZephioContext *ctx);
/** @brief Enable strikethrough attribute. */
ZEPHIO_API void ansi_set_strikethrough(ZephioContext *ctx);

/** @brief Write raw bytes to the terminal. */
ZEPHIO_API void ansi_write(ZephioContext *ctx, const char *text, size_t len);
/** @brief Write raw bytes at a specific position (1-based). */
ZEPHIO_API void ansi_write_at(ZephioContext *ctx, int row, int col, const char *text, size_t len);
